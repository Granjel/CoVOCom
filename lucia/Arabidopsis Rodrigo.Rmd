...
author: "Lucía Martín-Cacheda and Rodrigo R. Granjel"
date: today
output: html_document
---

# Setting up the working environment environment
...
# Effects of herbivory on emitters

```{r Herbivory emitters, echo = FALSE}
#| label: load-damage-emitters

# read herbivory emitter data
damage_emitters <- read.csv(
...
# check first rows
damage_emitters %>% head()

```


```{r normalidad, echo=FALSE}
#| label: explore-damage-emitters
...
# distribution of the response variable (herbivory_emitter)
hist(df$herbivory_emitter, main = "Raw values", xlab = "herbivory_emitter")

# square-root transformation
hist(
  sqrt(df$herbivory_emitter),
  main = "Square root transformed",
  xlab = "sqrt(herbivory_emitter)"
)

# log transformation (adding 1 to avoid log(0))
hist(
  log(df$herbivory_emitter + 1),
  main = "Log(x + 1) transformed",
  xlab = "log(herbivory_emitter + 1)"
)
```
